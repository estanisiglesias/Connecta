...
namespace uveIntegratorWindowsService
{
  ...
  public class WindowsServiceInstaller : Installer
  {
    ...
    public WindowsServiceInstaller()
    {
      ...
      serviceInstaller.DisplayName = "uveIntegrator Service";
      serviceInstaller.StartType = ServiceStartMode.Automatic;

      //# This must be identical to the WindowsService.ServiceBase name

      //# set in the constructor of WindowsService.cs
      serviceInstaller.ServiceName = "uveIntegrator Service";
      serviceInstaller.Description = "File integration service for ConnectA";
