...
namespace uveIntegratorWindowsService
{
  /// <summary>
  /// Clase que se ejecuta como servicio de Windows. El objetivo es que se lancen
  /// procesos SIP de manera automática, buscando en la cola de mensajes los items
  /// a gestionar.
  /// </summary>
  public partial class Service : ServiceBase
  {
    private uveIntegrator.uveIntegrator uve = null;
    ...
    public Service()
    {
      ...
      this.ServiceName = "uveIntegrator Service";
    ...
    protected override void OnStart(string[] args)
    {
      ...
      System.Threading.ThreadStart threadStart = new System.Threading.ThreadStart(RunIntegrator);
    ...
    public void RunIntegrator() 
    {
      ...
      uve = new uveIntegrator.uveIntegrator();
      uve.runAuto(arguments);
    }
