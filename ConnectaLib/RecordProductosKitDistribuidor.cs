...
namespace ConnectaLib 
{
  ...
  /// </summary>
  public class RecordProductosKitDistribuidor : CommonRecord
  {
    /// <summary>
    ...
    public string CodigoProductoComp { get { return GetValue("CodigoProductoComp"); } set { CodigoProductoComp = value; } }
